...
//                textViewResult.setText(t.getMessage());
                                Toast.makeText(ColporateActivity.this, t.getMessage(), LENGTH_SHORT).show();
                            }
                        });
...
//                        Toast.makeText(ColporateActivity.this, "Come back tomorrow!", Toast.LENGTH_SHORT).show();
                        openDialog();
                    }  else {
...
//        end colporate
    ...
    public void openDialog() {
        ...
        exampleDialog.show(getSupportFragmentManager(), "You session to day is done");
    }
